...
const companies: CompanySeed[] = [
  {
    ...
    type: "新势力",
    cities: ["北京", "上海"],
    directions: ["自动驾驶", "智能座舱", "三电", "嵌入式"],
    officialWebsite: "https://www.mi.com/car/",
    recruitmentWebsite: "https://hr.xiaomi.com/campus",
    access: "ok",
    program: {
      title: "2027届应届实习计划",
      sourceUrl: "https://hr.xiaomi.com/campus",
      actionLabel: "查看小米 2027 届实习说明",
      evidenceSummary:
        "小米招聘校园门户明确写明“应届实习”面向 2027 届毕业生；原 /campus/0 深链已返回 404，不再作为项目入口。",
      note: "官方校园招聘门户包含面向 2027 届毕业生的应届实习说明；具体岗位与截止时间需进入站内实时核对。",
    },
  },
  {
    id: "li-auto",
    ...
    type: "新势力",
    cities: ["北京", "上海", "常州"],
    directions: ["整车研发", "自动驾驶", "底盘", "测试验证"],
    officialWebsite: "https://www.lixiang.com/",
    recruitmentWebsite: "https://www.lixiang.com/employ/campus.html",
    access: "ok",
  },
  {
    id: "nio",
    ...
    type: "新势力",
    cities: ["上海", "合肥"],
    directions: ["三电", "车载软件", "整车研发", "智能座舱"],
    officialWebsite: "https://www.nio.cn/",
    recruitmentWebsite: "https://campus.nio.com/",
    access: "ok",
  },
  {
    id: "xpeng",
    ...
    type: "新势力",
    cities: ["广州", "上海"],
    directions: ["自动驾驶", "智能座舱", "车载软件", "测试验证"],
    officialWebsite: "https://www.xiaopeng.com/",
    recruitmentWebsite: "https://xiaopeng.jobs.feishu.cn/campus/",
    access: "ok",
    program: {
      title: "2027届暑期实习项目",
      sourceUrl: "https://xiaopeng.jobs.feishu.cn/campus/",
      actionLabel: "查看小鹏 2027 暑期实习",
      evidenceSummary: "小鹏官方校园招聘页明确列出面向 2027 届毕业生的暑期实习项目。",
      note: "官方校园招聘页面明确面向 2027 届毕业学生；具体岗位与截止时间以站内实时信息为准。",
    },
  },
  {
    id: "leapmotor",
    ...
    type: "新势力",
    cities: ["杭州", "金华"],
    directions: ["三电", "整车研发", "测试验证", "电池"],
    officialWebsite: "https://www.leapmotor.com/",
    recruitmentWebsite: "https://leapmotor1.zhiye.com/campus",
    access: "ok",
  },
  {
    id: "zeekr",
    ...
    type: "新势力",
    cities: ["杭州", "宁波"],
    directions: ["整车研发", "智能座舱", "底盘", "三电"],
    officialWebsite: "https://www.zeekrgroup.com/",
    recruitmentWebsite: "https://www.zeekrgroup.com/join-us",
    access: "ok",
  },
  {
    id: "tesla",
    ...
    type: "外资车企",
    cities: ["上海", "北京"],
    directions: ["制造工艺", "电池", "自动驾驶", "测试验证"],
    officialWebsite: "https://www.tesla.cn/",
    recruitmentWebsite: "https://www.tesla.cn/careers",
    access: "limited",
  },
  {
    id: "byd",
    ...
    type: "传统车企",
    cities: ["深圳", "西安", "合肥"],
    directions: ["电池", "电机电控", "整车研发", "热管理"],
    officialWebsite: "https://www.bydglobal.com/cn/",
    recruitmentWebsite: "https://job.byd.com/portal/mobile/school-home",
    access: "ok",
    program: {
      title: "2026/2027届实习生招聘",
      sourceUrl: "https://job.byd.com/portal/mobile/school-home",
      actionLabel: "打开比亚迪 2027 实习招聘入口",
      evidenceSummary: "比亚迪官方校园招聘门户明确写明实习生招聘面向 2026 届、2027 届在校生。",
      note: "官方校园招聘页面包含面向 2027 届在校生的实习招聘说明；正式秋招批次与截止时间仍需等待官方发布。",
    },
  },
  {
    id: "geely",
    ...
    type: "传统车企",
    cities: ["杭州", "宁波"],
    directions: ["整车研发", "底盘", "智能座舱", "车载软件"],
    officialWebsite: "https://www.geely.com/",
    recruitmentWebsite: "https://campus.geely.com/",
    access: "ok",
  },
  {
    id: "changan",
    ...
    type: "传统车企",
    cities: ["重庆", "上海"],
    directions: ["整车研发", "三电", "CAE仿真", "测试验证"],
    officialWebsite: "https://www.changan.com.cn/",
    recruitmentWebsite: "https://changan.zhiye.com/Campus",
    access: "ok",
  },
  {
    id: "gac",
    ...
    type: "传统车企",
    cities: ["广州"],
    directions: ["整车研发", "车身", "车载软件", "测试验证"],
    officialWebsite: "https://www.gac.com.cn/",
    recruitmentWebsite: "https://www.gacgroup.com/cn/talent",
    access: "ok",
  },
  {
    id: "saic",
    ...
    type: "传统车企",
    cities: ["上海"],
    directions: ["整车研发", "车载软件", "测试验证", "智能座舱"],
    officialWebsite: "https://www.saicmotor.com/",
    recruitmentWebsite: "https://saic-recruit.saicmotor.com/",
    access: "review",
  },
  {
    id: "faw",
    ...
    type: "传统车企",
    cities: ["长春", "南京"],
    directions: ["整车研发", "底盘", "制造工艺", "测试验证"],
    officialWebsite: "https://www.faw.com.cn/",
    recruitmentWebsite: "https://faw-zhaopin.hotjob.cn/",
    access: "ok",
  },
  {
    id: "dongfeng",
    ...
    type: "传统车企",
    cities: ["武汉"],
    directions: ["动力总成", "三电", "测试验证", "整车研发"],
    officialWebsite: "https://www.dfmc.com.cn/",
    recruitmentWebsite: "https://dfmc.hotjob.cn/",
    access: "ok",
  },
  {
    id: "great-wall",
    ...
    type: "传统车企",
    cities: ["保定", "上海"],
    directions: ["底盘", "动力总成", "自动驾驶", "整车研发"],
    officialWebsite: "https://www.gwm.com.cn/",
    recruitmentWebsite: "https://zhaopin.gwm.cn/",
    access: "ok",
  },
  {
    id: "catl",
    ...
    type: "电池三电",
    cities: ["宁德", "上海", "溧阳"],
    directions: ["电池", "热管理", "测试验证", "电机电控"],
    officialWebsite: "https://www.catl.com/",
    recruitmentWebsite: "https://career.catl.com/",
    access: "limited",
  },
  {
    id: "calb",
    ...
    type: "电池三电",
    cities: ["常州", "成都"],
    directions: ["电池", "制造工艺", "热管理", "测试验证"],
    officialWebsite: "https://www.calb-tech.com/",
    recruitmentWebsite: "https://calbjs.zhiye.com/campus",
    access: "ok",
  },
  {
    id: "bosch",
    ...
    type: "零部件",
    cities: ["苏州", "上海", "无锡"],
    directions: ["底盘", "电机电控", "自动驾驶", "嵌入式"],
    officialWebsite: "https://www.bosch.com.cn/",
    recruitmentWebsite: "https://www.bosch.com.cn/careers/",
    access: "ok",
  },
  {
    id: "continental",
    ...
    type: "零部件",
    cities: ["上海", "芜湖"],
    directions: ["智能座舱", "底盘", "嵌入式", "测试验证"],
    officialWebsite: "https://www.continental.com/zh-cn/",
    recruitmentWebsite: "https://www.continental.com/en/career/",
    access: "ok",
  },
  {
    id: "zf",
    ...
    type: "零部件",
    cities: ["上海", "杭州"],
    directions: ["动力总成", "底盘", "测试验证", "制造工艺"],
    officialWebsite: "https://www.zf.com/china/zh/home/home.html",
    recruitmentWebsite: "https://jobs.zf.com/?locale=zh_CN",
    access: "ok",
  },
  {
    id: "denso",
    ...
    type: "零部件",
    cities: ["上海", "广州"],
    directions: ["热管理", "电机电控", "嵌入式", "测试验证"],
    officialWebsite: "https://www.denso.com/cn/zh/",
    recruitmentWebsite: "https://www.denso.com/cn/zh/careers/",
    access: "limited",
  },
  {
    id: "horizon",
    ...
    type: "智能化供应商",
    cities: ["北京", "上海"],
    directions: ["自动驾驶", "嵌入式", "车载软件", "测试验证"],
    officialWebsite: "https://www.horizon.cc/",
    recruitmentWebsite: "https://horizon-campus.hotjob.cn/",
    access: "ok",
  },
  {
    id: "momenta",
    ...
    type: "自动驾驶",
    cities: ["苏州", "上海", "北京"],
    directions: ["自动驾驶", "测试验证", "车载软件", "C++"],
    officialWebsite: "https://www.momenta.cn/",
    recruitmentWebsite: "https://momenta.jobs.feishu.cn/campus/m/",
    access: "ok",
  },
  {
    id: "jingwei-hirain",
    ...
    type: "智能化供应商",
    cities: ["北京", "天津", "上海"],
    directions: ["嵌入式", "车载软件", "测试验证", "自动驾驶"],
    officialWebsite: "https://www.hirain.com/",
    recruitmentWebsite: "https://www.hirain.com/news/%E6%A0%A1%E5%9B%AD%E6%8B%9B%E8%81%98-16",
    access: "limited",
  },
  {
    id: "hesai",
    ...
    type: "智能化供应商",
    cities: ["上海"],
    directions: ["自动驾驶", "嵌入式", "测试验证", "制造工艺"],
    officialWebsite: "https://www.hesaitech.com/cn/",
    recruitmentWebsite: "https://www.hesaitech.com/cn/careers",
    access: "ok",
  },
];
...
const finalUrlByUrl: Record<string, string> = {
  ...
  "https://saic-recruit.saicmotor.com/":
    "https://saic-recruit.saicmotor.com/recruit/pc/#/collegeRecruit",
  ...
  "https://www.lixiang.com/employ/campus.html":
...
const resources = [
  {
    id: "autonomous-driving-interview",
    title: "自动驾驶算法面试准备框架",
    type: "面经",
    summary: "按感知、预测、规划控制、仿真评测和项目复盘组织准备项，不包含任何企业题库。",
    tags: ["自动驾驶", "C++", "测试验证"],
    content: [
      {
        heading: "先确定岗位子方向",
        paragraphs: [
          "自动驾驶岗位的考察差异很大。先区分感知、预测、规划、控制、定位与仿真测试，再按目标岗位收窄准备范围。",
        ],
        checklist: ["能用两分钟解释目标岗位解决的问题", "能说清输入、输出、评价指标和失败模式"],
      },
      {
        heading: "算法与工程基础",
        paragraphs: [
          "感知方向重点复习坐标系、标定、检测与跟踪；规划控制方向重点复习搜索、优化、车辆模型和闭环稳定性。",
        ],
        checklist: ["准备一段可手写或口述的核心算法", "解释时间复杂度与工程取舍"],
      },
      {
        heading: "项目复盘",
        paragraphs: [
          "项目回答应包含问题定义、数据或场景、个人贡献、指标变化、失败案例和下一步改进。",
        ],
        checklist: ["避免只描述团队成果", "准备一次错误定位与修复过程"],
      },
    ],
  },
  {
    id: "embedded-cpp-interview",
    title: "车载嵌入式 C/C++ 面试检查表",
    type: "面经",
    summary: "覆盖内存、并发、通信协议、RTOS、Linux 与调试方法，适合车载软件方向自查。",
    tags: ["嵌入式", "C++", "智能座舱"],
    content: [
      {
        heading: "语言与内存",
        paragraphs: ["从对象生命周期、栈与堆、指针与引用、RAII、虚函数和常见未定义行为开始复习。"],
        checklist: ["能解释一次内存泄漏定位", "能比较深拷贝与移动语义"],
      },
      {
        heading: "实时与并发",
        paragraphs: ["准备任务调度、中断、互斥、条件变量、优先级反转以及实时系统中的延迟来源。"],
        checklist: ["能画出一次生产者消费者时序", "能解释如何避免死锁"],
      },
      {
        heading: "车载通信与调试",
        paragraphs: ["CAN、LIN、车载以太网与诊断协议需要结合报文、故障码和实际调试工具说明。"],
        checklist: ["准备一例总线异常定位", "说明日志、示波器或抓包工具的使用"],
      },
    ],
  },
  {
    ...
    title: "底盘与车辆动力学复习路径",
    type: "笔试",
    summary: "围绕悬架、制动、转向、整车动力学、仿真和试验验证梳理知识结构。",
    tags: ["底盘", "整车研发", "测试验证"],
    content: [
      {
        heading: "建立整车坐标与受力图",
        paragraphs: ["先统一纵向、横向、垂向和横摆等坐标定义，再从轮胎力与车身受力建立分析路径。"],
        checklist: ["能画单轨模型", "能解释质心位置的影响"],
      },
      {
        heading: "底盘系统",
        paragraphs: ["按悬架、转向、制动和轮胎四部分复习结构、关键参数、控制目标与典型故障。"],
        checklist: ["比较不足转向与过度转向", "说明制动稳定性的关键因素"],
      },
      {
        heading: "仿真与试验",
        paragraphs: ["把模型、输入工况、评价指标和试验相关性放在同一条验证链路中。"],
  ...
  },
  {
    ...
    title: "三电、电池与热管理知识清单",
    type: "笔试",
    summary: "梳理电池系统、电机电控、BMS、热管理与新能源汽车基础概念。",
    tags: ["三电", "电池", "热管理"],
    content: [
      {
        heading: "电池系统",
        paragraphs: [
          "复习电芯体系、串并联、SOC/SOH、均衡、热失控和高压安全，注意区分估算算法与系统工程。",
        ],
        checklist: ["解释 SOC 估算误差来源", "说明热失控传播的抑制思路"],
      },
      {
        heading: "电机与电控",
        paragraphs: ["理解永磁同步电机基本结构、转矩产生、逆变器和常见控制框架。"],
        checklist: ["比较不同工况下的效率关注点", "说明弱磁控制的目的"],
      },
      {
        heading: "热管理",
        paragraphs: ["从热源、热阻、冷却回路、控制策略和极端工况五个角度组织答案。"],
        checklist: ["画出典型冷却回路", "说明低温与快充的矛盾"],
      },
    ],
  },
  {
    ...
    title: "在线测评与群面准备方法",
    type: "测评",
    summary: "总结行测、性格测评、无领导小组讨论和时间分配方法，不代表企业官方流程。",
    tags: ["测试验证", "群面", "HR面"],
    content: [
      {
        heading: "在线测评",
        paragraphs: ["先确认题型、时限和设备要求。练习重点是稳定节奏，不是记忆所谓企业题库。"],
        checklist: ["提前测试浏览器与网络", "为资料分析和图表题设定时间上限"],
      },
      {
        heading: "群面",
        paragraphs: ["贡献可以是定义问题、建立标准、推进收敛或总结表达，不必争抢主持角色。"],
        checklist: ["先记录共同目标", "用证据推动而非重复观点"],
      },
      {
        heading: "HR 面",
        paragraphs: ["把动机、地点、岗位选择和项目经历保持一致，避免不同轮次出现互相冲突的答案。"],
        checklist: ["准备岗位选择理由", "准备一次真实挫折与复盘"],
      },
    ],
  },
  {
    ...
    title: "车辆方向简历项目表达指南",
    type: "简历",
    summary: "将课程设计、竞赛、仿真、控制、嵌入式和实习经历转化为可核验的岗位语言。",
    tags: ["整车研发", "自动驾驶", "嵌入式"],
    content: [
      {
        heading: "先对齐岗位",
        paragraphs: [
          "每段经历只保留与目标岗位有关的问题、方法、工具和结果，删除不能支撑岗位能力的背景铺陈。",
        ],
        checklist: ["标题直接说明项目对象", "首句写清个人责任"],
      },
      {
        heading: "写出可核验结果",
        paragraphs: [
          "结果可以是性能指标、测试覆盖、故障定位时间、资源占用或交付节点，不应编造百分比。",
        ],
        checklist: ["每个数字都能解释来源", "没有数字时说明验收标准"],
      },
      {
        heading: "准备追问",
        paragraphs: [
          "简历中的每个技术名词都可能被追问。准备设计选择、替代方案、失败过程和复现实验。",
        ],
        checklist: ["能画系统架构", "能解释最难的一次取舍"],
      },
    ],
  },
];
  ...
  for (const item of companies) {
    ...
    await prisma.company.create({
      data: {
        ...
        changeSummary: item.program
          ? "重新核验 2027 届项目证据与入口状态"
          : "完成招聘入口浏览器核验",
      ...
      data: [
        {
          ...
          isPrimary: false,
          httpStatus:
            health.official === "BLOCKED" ? 403 : health.official === "MANUAL_REVIEW" ? null : 200,
        },
        {
          ...
          httpStatus:
            health.recruitment === "BLOCKED"
              ? 403
              : health.recruitment === "MANUAL_REVIEW"
                ? null
                : 200,
        },
      ],
    ...
    if (item.id === "xiaomi-auto") {
      await prisma.companyLink.create({
        data: {
          ...
          healthStatus: "DEAD",
          evidenceSummary:
            "2026-06-11 使用真实浏览器访问返回 404，因此不再作为投递入口或 2027 届开放证据。",
          isPrimary: false,
          httpStatus: 404,
        },
      });
