...
# 2026-06-11 Vehicle Campus Hub 2.0

- [x] 审计 25 家企业官网与招聘入口候选
- [x] 区分招聘官网、2027 项目证据和核验时间
- [x] 删除伪岗位、重复资料和未核验日历事件
- [x] 重构首页、公司库、详情、日历与资料页
- [x] 增加版本、变更日志、设计与重构报告
- [x] 更新 Playwright 结构、可信度和多视口测试
- [x] Git 提交、推送与 Vercel 生产验证
